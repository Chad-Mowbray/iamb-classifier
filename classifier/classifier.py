...
class Classifier:
    ...
    def test_model(self, flattened_all_period_features):
        ...
        for file in ["gaussiannb", "linearSVC",  "MultinomialNB", "ComplementNB", "RandomForestClassifier", "GradientBoostingClassifier", "MLPClassifier"]:
            filepath = os.path.join(os.path.dirname(__file__), f"models/{file}_test-trained-model.pickle")
            with open(filepath, "rb") as f:
                model = pickle.load(f)
                print(model.predict(flattened_all_period_features))
    ...
    def main(self):
        ...
        self.test_model(flattened_all_period_features)
