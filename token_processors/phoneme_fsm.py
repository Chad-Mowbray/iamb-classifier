...
class PhonemeFSM():
    ...
    def _normalize(self, token):
        ...
        spelling_normalized, has_apostrophe, apostrophe_position = SpellingNormalizer(token, self._uk_us_dict).modernized_word
    ...
    def _compound(self):
        ...
        token = self.normalized_spelling if self.normalized_spelling else self._initial_token
        compound = Compounds(token, self._dicts.words, self._dicts.lemmatizer, self._uk_us_dict).find_compound_in_wordlist()
